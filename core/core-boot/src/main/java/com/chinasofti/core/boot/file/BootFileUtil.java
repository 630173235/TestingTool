...
public class BootFileUtil {
	 ...
	 * @return BladeFile
	 */
	public static BootFile getFile(MultipartFile file) {
	 ...
	 * @return BladeFile
	 */
	public static BootFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static BootFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new BootFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return BladeFile
	 */
	public static List<BootFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return BladeFile
	 */
	public static List<BootFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return BladeFile
	 */
	public static List<BootFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<BootFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new BootFile(file, dir, path, virtualPath));
		}
		return list;
	}
