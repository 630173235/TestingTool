...
@Slf4j
@AllArgsConstructor
public class BootConverter implements Converter {
	...
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = BootConverter.getTypeDescriptor(targetClazz, (String) fieldName);
    ...
    {
        return str(obj, Charsets.UTF_8_NAME);
    }
