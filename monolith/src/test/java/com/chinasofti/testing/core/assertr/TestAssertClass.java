...
public class TestAssertClass {
	...
	private String packageName = "com.chinasofti.testing.core.assertr";
	
	protected final static Logger logger = LoggerFactory.getLogger(TestAssertClass.class);
	
	@Test
	public void testAnnotation() throws AssertDefinitionException
	{
	    ...
	    logger.debug( JsonUtil.toJson( assertClass.getAssertTemplates() ) );
	}
}
